...
<body>
<div id="submitView" class="viewer clearfix" style="background-color: #f0f0f0;display: flex">
	...
	<div class="logoDiv"
		...
		<div id="hy" style="color: white;margin-right: 10px;line-height: 40px;float: right;display: inline-block; width: 40px;">
			会 员
		</div>
